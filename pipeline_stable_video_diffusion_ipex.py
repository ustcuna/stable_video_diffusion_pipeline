...
class StableVideoDiffusionPipelineIpex(
    ...
    def prepare_for_ipex(
        ...
        # self.unet = self.unet.to(memory_format = torch.channels_last_3d)

        unet_input_example = {"sample": latent_model_input, "timestep": dummy, "encoder_hidden_states" : image_embeddings, "added_time_ids": added_time_ids}
